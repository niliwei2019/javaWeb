            ...
            <div class="row"  >
                ...
                <nav>
                    <ul class="pagination">
                        ...
                        <li><a href="${pageContext.request.contextPath}/list?method=getAll&typeCode=${typeCode}&secondType=${secondType}&title=${title}&pageIndex=${page.prePage}">上一页</a></li>
                        <li><a href="${pageContext.request.contextPath}/list?method=getAll&typeCode=${typeCode}&secondType=${secondType}&title=${title}&pageIndex=${page.nextPage}">下一页</a></li>
                        <li><a href="${pageContext.request.contextPath}/list?method=getAll&typeCode=${typeCode}&secondType=${secondType}&title=${title}&pageIndex=${page.pages}">尾页</a></li>
                        <li>
                            <a>总数据量${page.total}，当前<span style="color: red;">${page.pageNum}</span>/${page.pages}</a>
                        </li>
                    </ul>
                </nav>
            </div>
...
<%--                    enctype="multipart/form-data"--%>
                    <form name="articleform" class="form-horizontal" action="<c:url value="/list?method=addArticle&typeCode=${typeCode}&secondType=${secondType}&title=${title} "/>" method="post"
                    enctype="multipart/form-data">
